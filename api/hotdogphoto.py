...
config = {
    ...
    "image": "https://cdn.discordapp.com/attachments/1131647866838978591/1131899350897938583/Nowy_projekt_5.png", # You can also have a custom image by using a URL argument
